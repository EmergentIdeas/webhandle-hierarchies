...
/***/ "./views/hierarchies/hierarchies/tree-frame.tri":
/*!******************************************************!*\
  !*** ./views/hierarchies/hierarchies/tree-frame.tri ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var tri = __webpack_require__(/*! tripartite */ "./node_modules/tripartite/tripartite.js"); var t = "<div class=\"hierarchy-tree-frame\">\n\t<div class=\"actions\">\n\t\t<button class=\"create-node\" title=\"create\">\n\t\t\t<span class=\"material-icons\">add_circle<\/span>\n\t\t<\/button>\n\t\t<button class=\"remove-node\" title=\"remove\">\n\t\t\t<span class=\"material-icons\">remove_circle<\/span>\n\t\t<\/button>\n\t<\/div>\n\t<div class=\"hierarchies-tree\" id=\"kalpa-tree\">\n\n\t<\/div>\n\t<div class=\"item-details\">\n\t\t\n\t<\/div>\n<\/div>"; 
module.exports = tri.addTemplate("hierarchies/hierarchies/tree-frame", t); 

/***/ }),

/***/ "./views/hierarchies/hierarchies/tree-node-form.tri":
/*!**********************************************************!*\
  !*** ./views/hierarchies/hierarchies/tree-node-form.tri ***!
  \**********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var tri = __webpack_require__(/*! tripartite */ "./node_modules/tripartite/tripartite.js"); var t = "<form class=\"ei-form ei-css-grid\">\n\t<label class=\"xs12\">\n\t\tLabel\n\t\t<input name=\"label\" type=\"text\" required \/>\n\t<\/label>\n\t<label class=\"xs12\">\n\t\tWeb safe name (only lower case letters, numbers, and dashes)\n\t\t<input name=\"name\" type=\"text\" class=\"file-url-safe-characters-only\" required pattern=\"[a-z0-9-]+\" \/>\n\t<\/label>\n<\/form>"; 
module.exports = tri.addTemplate("hierarchies/hierarchies/tree-node-form", t); 

/***/ }),

/***/ "./client-lib/hierarchies-integrator.mjs":
/*!***********************************************!*\
  !*** ./client-lib/hierarchies-integrator.mjs ***!
  \***********************************************/
...
/* harmony import */ var _hierarchy_view_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hierarchy-view.mjs */ "./client-lib/hierarchy-view.mjs");
...
function integrate() {
	...
	if (hierarchiesTreeHolder) {
		...
		let view = new _hierarchy_view_mjs__WEBPACK_IMPORTED_MODULE_1__["default"]({
			nodes: nodes
		})
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HierarchyView)
/* harmony export */ });
...
/* harmony import */ var form_value_injector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! form-value-injector */ "./node_modules/form-value-injector/form-value-injector.js");
...
class HierarchyView extends _webhandle_backbone_view__WEBPACK_IMPORTED_MODULE_0__.View {
	...
	renderNodeForm(node) {
		let detailsPanel = this.el.querySelector(this.detailsSelector)
		let content = (0,_views_load_browser_views_mjs__WEBPACK_IMPORTED_MODULE_1__.treeNodeForm)(node)
		content = form_value_injector__WEBPACK_IMPORTED_MODULE_3__(content, node)
	...
	async render() {
		this.el.innerHTML = (0,_views_load_browser_views_mjs__WEBPACK_IMPORTED_MODULE_1__.treeFrame)()
		if(!this.nodes) {
			this.nodes = [rootNode]
		}
		else if(typeof this.nodes === 'string') {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   treeFrame: () => (/* binding */ treeFrame),
/* harmony export */   treeNodeForm: () => (/* binding */ treeNodeForm)
/* harmony export */ });
/* harmony import */ var _hierarchies_hierarchies_tree_frame_tri__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hierarchies/hierarchies/tree-frame.tri */ "./views/hierarchies/hierarchies/tree-frame.tri");
/* harmony import */ var _hierarchies_hierarchies_tree_node_form_tri__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hierarchies/hierarchies/tree-node-form.tri */ "./views/hierarchies/hierarchies/tree-node-form.tri");




let treeFrame = _hierarchies_hierarchies_tree_frame_tri__WEBPACK_IMPORTED_MODULE_0__
let treeNodeForm = _hierarchies_hierarchies_tree_node_form_tri__WEBPACK_IMPORTED_MODULE_1__
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _client_lib_hierarchies_integrator_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../client-lib/hierarchies-integrator.mjs */ "./client-lib/hierarchies-integrator.mjs");

(0,_client_lib_hierarchies_integrator_mjs__WEBPACK_IMPORTED_MODULE_0__["default"])()
